		...
		>
			<div className="flex flex-col gap-4">
				<h1 className="text-4xl font-semibold font-edensor text-[#660033] max-w-sm">
					{moduleData.location_name ?? "Kediaman Keluarga"}
				</h1>
				<p className="mt-2 text-lg text-[#660033] font-edensor max-w-sm font-medium">
					{moduleData.location_address ??
						"Jalan Pepaya, Komp. Perumahan Harperindo AA2/D28 Ciputat Timur, Tangerang Selatan 15412"}
				</p>
			</div>
			<motion.div
			...
			>
				<Image
					src={moduleData.image ?? "/designs/classic/joglo-new.webp"}
					alt="Couple"
					className=""
					width={400}
					height={300}
			...
			>
				<a
					href={moduleData.google_maps_url ?? "https://maps.app.goo.gl/HsPQWHgSdWeMuS7M6"}
					className="flex items-center gap-2"
					target="_blank"
					rel="noopener noreferrer"
				>
					<MapPinned className="h-6 w-6 text-[#660033]" />
					<p className="text-[#660033] font-edensor font-medium">Lihat Peta</p>
				</a>
			</Button>
		</section>
	);
